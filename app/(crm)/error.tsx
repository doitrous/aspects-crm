  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-canvas p-6" role="alert">
      <div className="w-full max-w-md rounded-card border border-line-soft bg-panel p-6 text-center shadow-sm">
        ...
        <h1 className="mt-3 text-lg font-black text-ink-900">This page could not be loaded</h1>
        <p className="mt-2 text-sm text-ink-500">Your data was not changed. Check the connection and try again.</p>
