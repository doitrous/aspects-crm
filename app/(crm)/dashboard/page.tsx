  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-auto bg-canvas/40 px-[18px] py-5">
        ...
        {/* Pipeline summary */}
        <h2 className="mb-2 mt-7 font-display text-[18px] font-semibold text-clinic-ink">
          Pipeline
        </h2>
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-6">
          {STAGE_ORDER.map((stage) => {
            ...
            return (
              ...
              >
                <span
                  className="inline-flex rounded-pill px-2 py-0.5 text-[10.5px] font-semibold"
                  style={{ background: meta.bg, color: meta.fg }}
                >
                  {meta.label}
                </span>
                <div className="mt-2 text-[24px] font-bold text-ink-900">
                  {p[stage]}
                </div>
              </Link>
            );
