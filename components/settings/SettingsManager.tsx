      ...
      <div className="min-w-0">
        ...
        {tab === "ingestion" && (
          <Card className="p-4">
            ...
            <p className="mb-3 text-[11.5px] text-ink-500">Complete canonical webhook history, newest first. A duplicate is a successful retry that was already registered; a failure requires review.</p>
