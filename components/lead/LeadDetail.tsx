          ...
          <div className="flex flex-col gap-5 p-5">
            ...
            <section>
              ...
              >
                ...
                <label className="text-[11.5px] font-semibold text-ink-500">MRN <span className="font-normal text-ink-400">(local clinic record number)</span><input name="mrn" inputMode="numeric" pattern="\d{4,6}" minLength={4} maxLength={6} defaultValue={lead.mrn ?? ""} placeholder="4–6 digits" className="mt-1 h-9 w-full rounded-control border border-line bg-panel px-2.5 font-mono text-[12.5px]" /><span className="mt-1 block text-[10px] font-normal text-ink-400">Exactly 4, 5, or 6 digits. Used to match bulk imports.</span></label>
